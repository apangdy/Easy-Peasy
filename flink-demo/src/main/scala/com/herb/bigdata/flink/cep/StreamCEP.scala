package com.herb.bigdata.flink.cep
...
object StreamCEP {
  def main(args: Array[String]): Unit = {
    ...
    val inputStream = env.readFile(reader, "flink-demo/data/source.txt", FileProcessingMode.PROCESS_CONTINUOUSLY, 10)
    ...
    val sink = StreamingFileSink
      .forRowFormat(new Path("flink-demo/data/sink.txt"), new SimpleStringEncoder[Warning]("UTF-8"))
      .build()
